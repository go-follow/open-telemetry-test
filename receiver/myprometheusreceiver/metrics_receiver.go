...
package myprometheusreceiver // import "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/prometheusreceiver"
...
import (
	...
	"github.com/go-follow/open-telemetry-test/receiver/myprometheusreceiver/internal"
...
func newPrometheusReceiver(set receiver.CreateSettings, cfg *Config, next consumer.Metrics, opts ...internal.Options) *pReceiver {
	options := internal.OptionsScrape{}
	...
	pr := &pReceiver{
		...
		errCh:               options.ScrapePrometheusErrCh,
	}
	return pr
}
...
func (r *pReceiver) Start(_ context.Context, host component.Host) error {
	...
	logger := internal.NewZapToGokitLogAdapter(r.settings.Logger, internal.WithScrapeError(r.errCh))
