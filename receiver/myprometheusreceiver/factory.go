...
import (
	...
	"github.com/go-follow/open-telemetry-test/receiver/myprometheusreceiver/internal/metadata"
)
...
func createMetricsReceiver(
	...
	return newPrometheusReceiver(set, cfg.(*Config), nextConsumer, internal.WithScrapeError(make(chan error))), nil
}
