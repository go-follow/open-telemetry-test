...
require (
	github.com/go-follow/open-telemetry-test/receiver/myprometheusreceiver v0.0.5
...
replace github.com/go-follow/open-telemetry-test/receiver/myprometheusreceiver => ../../receiver/myprometheusreceiver
